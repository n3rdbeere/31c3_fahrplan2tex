...
my $fahrplan_url = "https://events.ccc.de/congress/2014/Fahrplan/schedule.json";
my $version;
my @event_list;
...
$fahrplan_version = $1 . "_" . $2; 
$version = "cards_version_" . $fahrplan_version; 
$fahrplan_version =~ s/_/\./g;
#$version = "cards_version_" . $1 . "_" . $2; 
 
if (-e $version) {
    say "version " . $fahrplan_version . " has already been parsed... EXIT";
    exit 42;
}
